...
$(document).ready(function() {
  ...
  if ($(window).width() < 720) {
    ...
    var hh3 = 170;
        ...
        $('a[href="#dropdown1"]').on("click", function(event){
            event.preventDefault();
            $(".sec20 .block1").animate({'height':hh1},1000);
            $(this).css("display","none");
            $('a[href="#upper1"]').css("display","inline-block");
        });

        $('a[href="#upper1"]').on("click", function(event){
            event.preventDefault();
            $(".sec20 .block1").animate({'height':h1},1000);
            var posTop = (window.pageYOffset !== undefined) ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop;
            var scroll= posTop - (hh1-h1);
            $("html, body").animate({scrollTop:scroll},1000)
            $('a[href="#dropdown1"]').css("display","inline-block");
            $('a[href="#upper1"]').css("display","none");
        });

        $('a[href="#dropdown2"]').on("click", function(event){
            event.preventDefault();
            $(".sec20 .block2").animate({'height':hh2},1000);
            $(this).css("display","none");
            $('a[href="#upper2"]').css("display","inline-block");
        });

        $('a[href="#upper2"]').on("click", function(event){
            event.preventDefault();
            $(".sec20 .block2").animate({'height':h2},1000);
            var posTop = (window.pageYOffset !== undefined) ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop;
            var scroll= posTop - (hh2-h2);
            $("html, body").animate({scrollTop:scroll},1000)
            $('a[href="#dropdown2"]').css("display","inline-block");
            $('a[href="#upper2"]').css("display","none");
        });

        $('a[href="#dropdown3"]').on("click", function(event){
            event.preventDefault();
            $(".sec20 .block3").animate({'height':hh3},1000);
            $(this).css("display","none");
            $('a[href="#upper3"]').css("display","inline-block");
        });

        $('a[href="#upper3"]').on("click", function(event){
            event.preventDefault();
            $(".sec20 .block3").animate({'height':h3},1000);
            var posTop = (window.pageYOffset !== undefined) ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop;
            var scroll= posTop - (hh3-h3);
            $("html, body").animate({scrollTop:scroll},1000)
            $('a[href="#dropdown3"]').css("display","inline-block");
            $('a[href="#upper3"]').css("display","none");
        });
 // РёРЅРёС†РёР°Р»РёР·РёСЂСѓРµРј wow.js
